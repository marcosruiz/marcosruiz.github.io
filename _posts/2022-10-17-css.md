...
<details class="card mb-2">
  <summary class="card-header question">¿De dónde adónde van los valores de los colores RGB? ¿Qué significa la A de RGBA?</summary>
  <div class="card-body" markdown="1">
...
<details class="card mb-2">
  <summary class="card-header question">¿De dónde adónde va el valor de los colores HUE?</summary>
  <div class="card-body" markdown="1">
...
Puedes descargar la chuleta en español [aquí](/assets/img/css/css3-cheatsheet-emezeta.pdf).
