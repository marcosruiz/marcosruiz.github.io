...
<details class="card mb-2">
  <summary class="card-header question">¿Qué diferencia hay entre los elementos `block` y los elementos `inline`?</summary>
  <div class="card-body" markdown="1">
...
<details class="card mb-2">
  <summary class="card-header question">¿Qué diferencias hay entre las posiciones `static`, `relative`, `fixed`, `absolute`, `sticky`?</summary>
  <div class="card-body" markdown="1">
