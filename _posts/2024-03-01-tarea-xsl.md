...
Transforma el documento en formato Markdown que has entregado en la [Tarea: Introducción a XPath](/posts/tarea-xpath/) realiza las siguientes acciones:

1. Exporta el documento a formato HTML.
1. Transformarlo el documento HTML a formato XSL-FO con un XSLT.
