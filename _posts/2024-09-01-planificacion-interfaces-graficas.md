...
Nos comunicamos con el mundo que nos rodea a través de nuestros sentidos: la vista, el oído, el olfato, el gusto, el tacto, aunque actualmente empleamos únicamente la vista, el oído y el tacto en nuestra comunicación con el ordenador.
...
<details class="card mb-2">
  <summary class="card-header question">¿Es recomendable usar emojis en lugar de imágenes para los iconos?</summary>
  <div class="card-body" markdown="1">
...
<details class="card mb-2">
  <summary class="card-header question">¿Por qué crees que es importante en el diseño de página web reflejar los huecos?
</summary>
  <div class="card-body" markdown="1">
