...
> (Voluntario) Si quieres conocer todos los 61 criterios de conformidad de la WCAG 2.0 puedes leer el artículo [Criterios de conformidad de WCAG 2.0](https://accesibilidadweb.dlsi.ua.es/?menu=criterios-2.0).
{:.prompt-info}

> (Voluntario) Si quieres conocer todos los criterios de conformidad de la WCAG 2.2 EN DETALLE, puedes leer el artículo [WCAG 2.2](https://addaw.org/es/wcag).
{:.prompt-info}
...
![Básicos de desarrollo](Básicos de desarrollo_accesibilidad.svg)
