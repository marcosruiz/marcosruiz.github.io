...
- **Extensible Stylesheet Language Transformations** (XSLT), contiene instrucciones para transformar un documento XML en otros documentos (XML, HTML, XHTML y texto plano).
