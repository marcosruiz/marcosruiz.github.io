...
<details class="card mb-2">
  <summary class="card-header question">¿Qué temas me preparé?</summary>
  <div class="card-body" markdown="1">

Me preparé un total de 15 temas:

1. Tema 01. Representación y comunicación de la información.
1. Tema 61. Redes y servicios de comunicación.
1. Tema 62. Arquitecturas de sistemas de comunicaciones. Arquitecturas basadas en niveles. Estándares.
1. Tema 63. Funciones y servicios del nivel físico. Tipos y medios de transmisión. Adaptación al medio de transmisión. Limitaciones a la transmisión. Estándares.
...
1. Tema 71. Explotación y administración de sistemas en red local. Facilidades de gestión.
1. Tema 72. La seguridad en sistemas en red. Servicios de seguridad. Técnicas y sistemas de protección. Estándares.
1. Tema 73. Evaluación y mejora de prestaciones en un sistema en red. Técnicas y procedimientos de medidas.
1. Tema 74. Sistemas multimedia.

Con esto tuve un 66.10% de probabilidades de que salga al menos uno de los temas que estudié.
