...
<details class="card mb-2">
  <summary class="card-header question">¿Qué es un ERP en pocas palabras?</summary>
...
<details class="card mb-2">
  <summary class="card-header question">¿Qué es un kanban? ¿Conoces alguna aplicación de gestión de kanbans?</summary>
  <div class="card-body" markdown="1">
...
<details class="card mb-2">
  <summary class="card-header question">¿Qué es un TPV?</summary>
  <div class="card-body" markdown="1">
...
<details class="card mb-2">
  <summary class="card-header question">¿Qué es un dashboard? ¿Y un scoreboard?</summary>
  <div class="card-body" markdown="1">
...
![Cuadro de mando de un coche](cocheDashboard.png)
_Cuadro de mando de un coche_

![Cuadro de mando de un avión](avionDashboard.png)
_Cuadro de mando de un avión_
...
![Imagen con todos los módulos de Odoo en modo mosaico](modulosOdoo.png)
_Imagen con todos los módulos de Odoo en modo mosaico_
...
<details class="card mb-2">
  <summary class="card-header question">¿Por qué pagar para tener un ERP o un CRM?</summary>
  <div class="card-body" markdown="1">
...
<details class="card mb-2">
  <summary class="card-header question">¿Para qué nos puede ser útil un ERP?</summary>
  <div class="card-body" markdown="1">
