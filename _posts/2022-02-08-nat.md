...
- NAT estática (de correlación)
- NAT dinámica (ocultación)
...
![img-description](ejemploNat2.png)
_Ejemplo enmascaramiento IP sin cambio de puerto_

![img-description](ejemploNat3.png)
_Ejemplo enmascaramiento IP con cambio de puerto_

{:.subsubsection}
#### Otro ejemplo de funcionamiento PAT

![imgDescription](dynamic-pat-initial.png)
_Ejemplo de enmascaramiento IP: Envío_

![imgDescription](dynamic-pat-return.png)
_Ejemplo de enmascaramiento IP: Respuesta_

![imgDescription](dynamic-pat-failed-inbound-packet.png)
_Ejemplo de enmascaramiento IP: Conflicto de puerto_

![imgDescription](dynamic-pat-non-random-src-port-v5.png)
