...
El siguiente comando no es necesario pero si recomendable:
...
En mi caso, añado las siguientes clases CSS personalizadas:
...
> Si copias este texto en un fichero `.ps1` deberá ser en codificación Windows 1252.
{:.prompt-warning}
