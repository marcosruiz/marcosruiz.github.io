...
![Grafo](grafos-grafo.pdf){: width="400px"}
_Grafo_

Un grafo dirigido es un grafo en el que los arcos tienen dirección.

![Grafo dirigido](grafos-grafo-dirigido.pdf){: width="400px"}
_Grafo dirigido_
...
![Nodo padre y nodo hijo](grafos-padre-hijo.pdf){: width="400px"}
...
![Árbol](grafos-arbol.pdf){: width="400px"}
_Árbol_

![Árbol dirigido](grafos-arbol-dirigido.pdf){: width="400px"}
_Árbol dirigido_

El nodo raíz de un árbol dirigido es el único nodo sin padre. Los nodos hermanos son los nodos que tienen el mismo padre.

![Nodo raíz y nodos hermanos](grafos-raiz-hermanos.pdf){: width="400px"}
...
![Nodos descendientes](grafos-descendientes.pdf){: width="400px"}
...
![Nodos ascendientes](grafos-ascendientes.pdf){: width="400px"}
...
![Árbol de documento XML](grafos-documento.pdf)
