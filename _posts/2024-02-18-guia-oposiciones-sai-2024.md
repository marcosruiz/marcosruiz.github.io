...
<details class="card mb-2">
  <summary class="card-header question">¿Cuántos temas me preparo?</summary>
  <div class="card-body" markdown="1">

Haciendo click en [este enlace](https://www.opositatest.com/calcular-probabilidades/) puedes calcular las probabilidades de acertar en el tema. En mi caso son:

- 64 temas totales
- 5 bolas
- 26 temas voy a preparar:
  - Bloque 01 – Información, Hardware, Arquitectura
  - Bloque 07 – Bases De Datos
...
<details class="card mb-2">
  <summary class="card-header question">¿Cómo elijo el temario a estudiar?</summary>
  <div class="card-body" markdown="1">

Lo más recomendable es prepararte el temario por bloques ya que los temas suelen solaparse en cuanto a contenido.
...
<details class="card mb-2">
  <summary class="card-header question">¿Qué UD elijo y de que módulo profesional?</summary>
  <div class="card-body" markdown="1">

Lo mejor que puedes hacer es utilizar una UD que ya hayas preparado para clase, así ya contarás con una primera versión de teoría y práctica hecha. Es imprescindible que se alinee con los resultados de aprendizaje y criterios de evaluación del módulo profesional.

En caso de que no hayas dado ningún módulo profesional de la especialidad que te toca, siempre puedes mirar si hay contenidos que se solapen con tu especialidad de referencia. Recuerda que Informática también tiene las asignaturas de ESO y bachiller.

> Recuerda que la UD debe ser de la especialidad a la que te presentas. En caso contrario, tu nota será un 0 en esta parte.
{:.prompt-info}
