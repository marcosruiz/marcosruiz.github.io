---
title: "Crear Google Form desde Google Sheet"
date: 2022-03-15 11:00:00 +0100
categories: [General]
tags: [google, form, sheet, plantilla, automático, generación, script]
---

## Video explicativo de como se usa el script

<iframe width="1000%" height="315" src="https://www.youtube.com/embed/tXxkyxmWzEg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  ...
  var op = ro.getValues();
    if(i==''){continue;}
       ...
       if (d[x][3] !== '') {q.setPoints(d[x][3])}
        ...
        // Rows (second row)
        var ro2 = s.getRange(cr+1, 8, 1, 11);
